...
(async () => {
    ...
    await page.screenshot({ path: './tests/screenshots/games/01.png' });
    
    const [response] = await Promise.all([
        page.waitForNavigation(),
        page.click("body > main > main > div:nth-child(13) > div:nth-child(3) > div > div.card-body > a:nth-child(3) > button"),
      ]);
    ...
    await page.screenshot({ path: './tests/screenshots/games/02.png' });
    ...
    await page.screenshot({ path: './tests/screenshots/games/03.png' });
    await page.$eval('#add', el => el.click());
    
    await page.screenshot({ path: './tests/screenshots/games/04.png' });
    ...
    var finalrowCount = (await page.$$("body > main > main > table:nth-child(8) > tbody > tr:nth-child(1)")).length;
