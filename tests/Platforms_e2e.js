...
(async () => {
    ...
    await page.screenshot({ path: './tests/screenshots/platforms/01.png' });//Foto de la imagen inicial
    ...
    await page.$eval('body > main > main > table:nth-child(7) > tbody > tr:nth-child(1) > td:nth-child(6) > button', el => el.click()); //Insertar dato
    await page.waitForTimeout(2000);
    
    await page.click("body > main > main > ul > li:nth-child(4) > a");
    await page.waitForTimeout(3000);
    await page.screenshot({ path: './tests/screenshots/platforms/04.png' }); //borrar todo
